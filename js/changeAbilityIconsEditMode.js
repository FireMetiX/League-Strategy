...
function changeAbilityIcons() {
    ...
    // console.log(championSelect2.value);
    ...
    fetch(`http://ddragon.leagueoflegends.com/cdn/10.24.1/data/en_US/champion/${chosenChampion}.json`)
    ...
    .then(data => {
        for(x in data.data){
            ...
            // console.log(data.data[x].spells[0].image.full)
        }
    });
